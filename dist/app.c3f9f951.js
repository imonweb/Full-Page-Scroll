...
var navBtns = document.querySelectorAll('.navbuttons');
var activeSection;
/*  Helper functions */
// const actionSectionHandler = (currentSectionId) => {

var activeSectionHandler = function activeSectionHandler(currentSectionId) {
...
var setActiveSection = function setActiveSection(section) {
  ...
  activeSection = section; // console.log(activeSection);
};

var showPreviousSection = function showPreviousSection() {
...
var showNextSection = function showNextSection() {
...
var keyEventHandler = function keyEventHandler(keycode) {
  // console.log(keycode);
  switch (keycode) {
    case 'ArrowUp':
      // console.log('up');
...
var sectionWatcherCallback = function sectionWatcherCallback(section, sectionWatcher) {
...
var sectionWatcherOptions = {
  threshold: .5
};
var sectionWatcher = new IntersectionObserver(sectionWatcherCallback, sectionWatcherOptions);
